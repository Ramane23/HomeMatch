    ...
    def save_listings(
        ...
        with open(self.saving_path, "w") as fp:
            if listings and isinstance(listings[0], Document):
                ...
                json.dump([{"page_content": doc.page_content, "metadata": doc.metadata} for doc in listings], fp, indent=2)
            else:
...
if __name__=="__main__":
    ...
    listing = GenerateListings(saving_path = "./src/listings/docs/listings.json",)
